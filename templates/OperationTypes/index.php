 ...
 * @var iterable<\App\Model\Entity\OperationType> $operationTypes
 */
?>
<div class="operationTypes index content">
    <?= $this->Html->link(__('New Operation Type'), ['action' => 'add'], ['class' => 'button float-right']) ?>
