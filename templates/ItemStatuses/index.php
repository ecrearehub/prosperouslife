 ...
 * @var iterable<\App\Model\Entity\ItemStatus> $itemStatuses
 */
?>
<div class="itemStatuses index content">
    <?= $this->Html->link(__('New Item Status'), ['action' => 'add'], ['class' => 'button float-right']) ?>
    <h3><?= __('Item Statuses') ?></h3>
