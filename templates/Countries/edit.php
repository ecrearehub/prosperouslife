 ...
 * @var string[]|\Cake\Collection\CollectionInterface $countryStatuses
 */
?>
<div class="row">
    <aside class="column">
        ...
        <div class="countries form content">
            ...
            <fieldset>
                ...
                <?php
                    ...
                    echo $this->Form->control('iso_code');
                    echo $this->Form->control('phone_code');
                    echo $this->Form->control('country_status_id', ['options' => $countryStatuses, 'empty' => true]);
                ?>
            </fieldset>
